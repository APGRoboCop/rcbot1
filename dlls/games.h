...
// Added Sven Co-op v5 support [APG]RoboCop[CL]
	...
	{"csv15",	"cs.so",	"mp.dll",	"mp.dll",	"CS 1.5 for Steam"},
	{"czero",	"cs.so",	"mp.dll",	"mp.dll",	"Counter-Strike:Condition Zero"},
	...
	{"svencoop", "server.so", "server.dll", "Sven Coop"},
	...
	{"wizardwars",	"wizardwars_i386.so",	"wizardwars.dll",	"Wizard Wars"},
